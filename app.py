...
# dados utilizados
df = pd.read_csv(
    "https://raw.githubusercontent.com/jh0rdanp/Analise_salarios-Area_de_dados/refs/heads/main/salarios-dados.csv")
...
st.markdown(
    "Salariais na área de dados nos últimos anos. Utilize os filtros à esquerda.")
